...
namespace Universe.CelestialBodies.Planets.Snow
{
    public class SnowmanRenderer : CelestialBodyRenderer
    {
        ...
        public override void Spawn(Vector2 pos, int? seed)
        {
            ...
            leftArm.rotation = Quaternion.Euler(0, 0, RandomNum.GetFloat(-45, 135f, Target.RandomNumberGenerator));
            rightArm.rotation = Quaternion.Euler(0, 0, RandomNum.GetFloat(240, 300, Target.RandomNumberGenerator));

            leftEye.rotation = Quaternion.Euler(0, 0, RandomNum.GetFloat(0, 360, Target.RandomNumberGenerator));
            rightEye.rotation = Quaternion.Euler(0, 0, RandomNum.GetFloat(0, 360, Target.RandomNumberGenerator));
